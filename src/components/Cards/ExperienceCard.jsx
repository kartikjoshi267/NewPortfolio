...
const ExperienceCard = ({ experience }) => {
  return (
    <div className='experience-card flex flex-row gap-5 items-start justify-start h-max w-[100%] duration-150 bg-[#1738295d] lg:bg-transparent lg:hover:bg-[#1738295d] lg:hover:!opacity-100 lg:group-hover:opacity-50 p-4 rounded-lg'>
