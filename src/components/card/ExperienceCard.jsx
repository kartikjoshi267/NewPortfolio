...
const ExperienceCard = ({ experience }) => {
  return (
    <div className='experience-card flex flex-col lg:flex-row gap-5 items-stretch lg:items-start justify-stretch lg:justify-between h-max w-[100%] duration-150 bg-transparent lg:hover:bg-[#2231a35d] lg:hover:!opacity-100 lg:group-hover:opacity-50 p-4 rounded-lg'>
